...
template = """
    ...
    Final Answer: the final answer to the original input question backed up by substantial data without giving generic advice such as "it is important to conduct further research and consult with a financial advisor before making a decision" or "Please note that this is a fictional example and not a real investment advice."
